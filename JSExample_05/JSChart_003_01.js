...
*/
	...
	//loading pie chart data from outside file
	var data2, ex_pieData;

			$.get("testJSON.txt",function(ex_pieData){
				alert("Data from JavaScript file: " +ex_pieData + "typeof object " + typeof ex_pieData);
				data2 = eval('['+ ex_pieData + ']');
				});

		
			alert(data2);

			alert("Hello from JSChart_003_01.js");

				// pie chart data
	var pieData = eval('[' + ex_pieData + ']'); 
